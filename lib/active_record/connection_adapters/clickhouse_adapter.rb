...
module ActiveRecord
  ...
  module ConnectionAdapters
    ...
    class ClickhouseAdapter < AbstractAdapter
      ...
      def connect
        @connection = @connection_parameters[:connection] || Net::HTTP.start(@connection_parameters[:host], @connection_parameters[:port], read_timeout: @full_config[:read_timeout] || 600, use_ssl: @connection_parameters[:ssl], verify_mode: OpenSSL::SSL::VERIFY_NONE)
      end
